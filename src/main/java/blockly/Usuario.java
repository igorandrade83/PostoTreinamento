		...
		return new Callable<Var>() {
			...
			public Var call() throws Exception {
				...
				return cronapi.database.Operations.newEntity(Var.valueOf("app.entity.User"),
						Var.valueOf("id", cronapi.database.Operations.getField(usuarioLogado, Var.valueOf("this[3]"))),
						Var.valueOf("email",
								cronapi.database.Operations.getField(usuarioLogado, Var.valueOf("this[0]"))),
						Var.valueOf("name",
								cronapi.database.Operations.getField(usuarioLogado, Var.valueOf("this[2]"))),
						Var.valueOf("login",
								cronapi.database.Operations.getField(usuarioLogado, Var.valueOf("this[1]"))));
			}
		}.call();
	}
