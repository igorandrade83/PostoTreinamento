...
public interface PostoDAO extends JpaRepository<Posto, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.carros FROM Abastecimento entity WHERE entity.posto.id = :id")
  public Page<Carros> listCarros(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Abastecimento entity WHERE entity.posto.id = :instanceId AND entity.carros.id = :relationId")
  public int deleteCarros(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
